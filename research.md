...
with [Juan Pablo Torres-Martínez](https://econ.uchile.cl/es/academico/jutorres){:target="_blank" rel="noopener"} <br> 
 <button onclick="myFunction('abstract')">`Abstract`</button> <font size = "2">[`SSRN`](http://dx.doi.org/10.2139/ssrn.4276906){:target="_blank" rel="noopener"} [`Slides`](../files/research/Weak_Externalities_School_Choice/slides.pdf){:target="_blank" rel="noopener"} [`Slides (spanish)`](../files/research/Weak_Externalities_School_Choice/slides_esp.pdf){:target="_blank" rel="noopener"}</font>
